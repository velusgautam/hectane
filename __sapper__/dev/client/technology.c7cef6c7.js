...
const file = "src/routes/technology.svelte";
...
class Technology extends SvelteComponentDev {
	constructor(options) {
		...
		if (/*posts*/ ctx[0] === undefined && !("posts" in props)) {
			console.warn("<Technology> was created without expected prop 'posts'");
		}

		if (/*authorMap*/ ctx[1] === undefined && !("authorMap" in props)) {
			console.warn("<Technology> was created without expected prop 'authorMap'");
		}
	}
