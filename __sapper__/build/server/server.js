...
const Author = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${"post--author svelte-i3yt1c"}"><img class="${"img svelte-i3yt1c"}"${add_attribute("src", avathar, 0)} alt="${"Velu S Gautam"}">
  <div class="${"details svelte-i3yt1c"}"><div class="${"name"}">${escape(name)}</div>
...
const css$3 = {
	code: "nav.svelte-7nlfkf{font-weight:300;padding:0 1em;grid-area:nav;display:-webkit-box;display:flex;-webkit-box-pack:center;justify-content:center;-webkit-box-align:center;align-items:center;flex-wrap:wrap}ul.svelte-7nlfkf{margin:0;padding:0}ul.svelte-7nlfkf::after{content:\"\";display:block;clear:both}li.svelte-7nlfkf{display:block;float:left}[aria-current].svelte-7nlfkf{position:relative;display:inline-block}[aria-current].svelte-7nlfkf::after{position:absolute;content:\"\";width:calc(100% - 1em);height:2px;background-color:rgb(255, 62, 0);display:block;bottom:-1px}a.svelte-7nlfkf{text-decoration:none;padding:1em 0.5em;display:block;color:var(--black)}",
	map: "{\"version\":3,\"file\":\"Nav.svelte\",\"sources\":[\"Nav.svelte\"],\"sourcesContent\":[\"<script>\\n  export let segment;\\n</script>\\n\\n<style>\\n  nav {\\n    /* border-bottom: 1px solid rgba(255, 62, 0, 0.1); */\\n    font-weight: 300;\\n    padding: 0 1em;\\n    /* margin: 0 20px; */\\n    grid-area: nav;\\n    display: -webkit-box;\\n    display: flex;\\n    -webkit-box-pack: center;\\n    justify-content: center;\\n    -webkit-box-align: center;\\n    align-items: center;\\n    flex-wrap: wrap;\\n  }\\n\\n  ul {\\n    margin: 0;\\n    padding: 0;\\n  }\\n\\n  /* clearfix */\\n  ul::after {\\n    content: \\\"\\\";\\n    display: block;\\n    clear: both;\\n  }\\n\\n  li {\\n    display: block;\\n    float: left;\\n  }\\n\\n  [aria-current] {\\n    position: relative;\\n    display: inline-block;\\n  }\\n\\n  [aria-current]::after {\\n    position: absolute;\\n    content: \\\"\\\";\\n    width: calc(100% - 1em);\\n    height: 2px;\\n    background-color: rgb(255, 62, 0);\\n    display: block;\\n    bottom: -1px;\\n  }\\n\\n  a {\\n    text-decoration: none;\\n    padding: 1em 0.5em;\\n    display: block;\\n    color: var(--black);\\n  }\\n</style>\\n\\n<div>\\n  <h3 style=\\\"text-align:center\\\">\\n    <picture>\\n      <source srcset=\\\"logo.webp\\\" type=\\\"image/webp\\\" />\\n      <img src=\\\"logo.png\\\" alt=\\\"hectane logo\\\" />\\n    </picture>\\n  </h3>\\n  <nav class=\\\"margin-auto container \\\">\\n    <ul>\\n      <li>\\n        <a\\n          rel=\\\"prefetch\\\"\\n          aria-current={segment === undefined ? 'page' : undefined}\\n          href=\\\".\\\">\\n          Home\\n        </a>\\n      </li>\\n      <li>\\n        <a\\n          rel=\\\"prefetch\\\"\\n          aria-current={segment === 'technology' ? 'page' : undefined}\\n          href=\\\"technology\\\">\\n          Technology\\n        </a>\\n      </li>\\n      <li>\\n        <a\\n          rel=\\\"prefetch\\\"\\n          aria-current={segment === 'interviews' ? 'page' : undefined}\\n          href=\\\"interviews\\\">\\n          Interviews\\n        </a>\\n      </li>\\n      <li>\\n        <a\\n          rel=\\\"prefetch\\\"\\n          aria-current={segment === 'learnings' ? 'page' : undefined}\\n          href=\\\"learnings\\\">\\n          Learnings\\n        </a>\\n      </li>\\n      <li>\\n        <a\\n          rel=\\\"prefetch\\\"\\n          aria-current={segment === 'travelogue' ? 'page' : undefined}\\n          href=\\\"travelogue\\\">\\n          Travelouge\\n        </a>\\n      </li>\\n\\n      <!-- for the blog link, we're using rel=prefetch so that Sapper prefetches\\n\\t\\t     the blog data when we hover over the link or tap it on a touchscreen -->\\n      <!-- <li>\\n      <a\\n        rel=\\\"prefetch\\\"\\n        aria-current={segment === 'blog' ? 'page' : undefined}\\n        href=\\\"blog\\\">\\n        blog\\n      </a>\\n    </li> -->\\n    </ul>\\n  </nav>\\n</div>\\n\"],\"names\":[],\"mappings\":\"AAKE,GAAG,cAAC,CAAC,AAEH,WAAW,CAAE,GAAG,CAChB,OAAO,CAAE,CAAC,CAAC,GAAG,CAEd,SAAS,CAAE,GAAG,CACd,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,gBAAgB,CAAE,MAAM,CACxB,eAAe,CAAE,MAAM,CACvB,iBAAiB,CAAE,MAAM,CACzB,WAAW,CAAE,MAAM,CACnB,SAAS,CAAE,IAAI,AACjB,CAAC,AAED,EAAE,cAAC,CAAC,AACF,MAAM,CAAE,CAAC,CACT,OAAO,CAAE,CAAC,AACZ,CAAC,AAGD,gBAAE,OAAO,AAAC,CAAC,AACT,OAAO,CAAE,EAAE,CACX,OAAO,CAAE,KAAK,CACd,KAAK,CAAE,IAAI,AACb,CAAC,AAED,EAAE,cAAC,CAAC,AACF,OAAO,CAAE,KAAK,CACd,KAAK,CAAE,IAAI,AACb,CAAC,AAED,CAAC,YAAY,CAAC,cAAC,CAAC,AACd,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,YAAY,AACvB,CAAC,AAED,CAAC,YAAY,eAAC,OAAO,AAAC,CAAC,AACrB,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,EAAE,CACX,KAAK,CAAE,KAAK,IAAI,CAAC,CAAC,CAAC,GAAG,CAAC,CACvB,MAAM,CAAE,GAAG,CACX,gBAAgB,CAAE,IAAI,GAAG,CAAC,CAAC,EAAE,CAAC,CAAC,CAAC,CAAC,CACjC,OAAO,CAAE,KAAK,CACd,MAAM,CAAE,IAAI,AACd,CAAC,AAED,CAAC,cAAC,CAAC,AACD,eAAe,CAAE,IAAI,CACrB,OAAO,CAAE,GAAG,CAAC,KAAK,CAClB,OAAO,CAAE,KAAK,CACd,KAAK,CAAE,IAAI,OAAO,CAAC,AACrB,CAAC\"}"
};
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div><h3 style="${"text-align:center"}"><picture><source srcset="${"logo.webp"}" type="${"image/webp"}">
      <img src="${"logo.png"}" alt="${"hectane logo"}"></picture></h3>
  <nav class="${"margin-auto container  svelte-7nlfkf"}"><ul class="${"svelte-7nlfkf"}"><li class="${"svelte-7nlfkf"}"><a rel="${"prefetch"}"${add_attribute("aria-current", segment === undefined ? "page" : undefined, 0)} href="${"."}" class="${"svelte-7nlfkf"}">Home
        </a></li>
      <li class="${"svelte-7nlfkf"}"><a rel="${"prefetch"}"${add_attribute("aria-current", segment === "technology" ? "page" : undefined, 0)} href="${"technology"}" class="${"svelte-7nlfkf"}">Technology
        </a></li>
      <li class="${"svelte-7nlfkf"}"><a rel="${"prefetch"}"${add_attribute("aria-current", segment === "interviews" ? "page" : undefined, 0)} href="${"interviews"}" class="${"svelte-7nlfkf"}">Interviews
        </a></li>
      <li class="${"svelte-7nlfkf"}"><a rel="${"prefetch"}"${add_attribute("aria-current", segment === "learnings" ? "page" : undefined, 0)} href="${"learnings"}" class="${"svelte-7nlfkf"}">Learnings
        </a></li>
      <li class="${"svelte-7nlfkf"}"><a rel="${"prefetch"}"${add_attribute("aria-current", segment === "travelogue" ? "page" : undefined, 0)} href="${"travelogue"}" class="${"svelte-7nlfkf"}">Travelouge
        </a></li>
